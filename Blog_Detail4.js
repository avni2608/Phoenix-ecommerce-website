...
document.getElementById('blog_title4').innerHTML = blogJSON.blog_details.blogs[3].title;
document.getElementById('blog_quote4').innerHTML = blogJSON.blog_details.blogs[3].quote;
document.getElementById('describe4').innerHTML = blogJSON.blog_details.blogs[3].describe;
document.getElementById('sub_describe4').innerHTML = blogJSON.blog_details.blogs[3].sub_describe;
document.getElementById('author4').innerHTML = blogJSON.blog_details.blogs[3].author;