...
document.getElementById('blog_title6').innerHTML = blogJSON.blog_details.blogs[5].title;
document.getElementById('blog_quote6').innerHTML = blogJSON.blog_details.blogs[5].quote;
document.getElementById('describe6').innerHTML = blogJSON.blog_details.blogs[5].describe;
document.getElementById('sub_describe6').innerHTML = blogJSON.blog_details.blogs[5].sub_describe;
document.getElementById('author6').innerHTML = blogJSON.blog_details.blogs[5].author;