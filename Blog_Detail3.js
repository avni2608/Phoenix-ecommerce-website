...
document.getElementById('blog_title3').innerHTML = blogJSON.blog_details.blogs[2].title;
document.getElementById('blog_quote3').innerHTML = blogJSON.blog_details.blogs[2].quote;
document.getElementById('describe3').innerHTML = blogJSON.blog_details.blogs[2].describe;
document.getElementById('sub_describe3').innerHTML = blogJSON.blog_details.blogs[2].sub_describe;
document.getElementById('author3').innerHTML = blogJSON.blog_details.blogs[2].author;