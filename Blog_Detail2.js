...
document.getElementById('blog_title2').innerHTML = blogJSON.blog_details.blogs[1].title;
document.getElementById('blog_quote2').innerHTML = blogJSON.blog_details.blogs[1].quote;
document.getElementById('describe2').innerHTML = blogJSON.blog_details.blogs[1].describe;
document.getElementById('sub_describe2').innerHTML = blogJSON.blog_details.blogs[1].sub_describe;
document.getElementById('author2').innerHTML = blogJSON.blog_details.blogs[1].author;