...
document.getElementById('blog_title5').innerHTML = blogJSON.blog_details.blogs[4].title;
document.getElementById('blog_quote5').innerHTML = blogJSON.blog_details.blogs[4].quote;
document.getElementById('describe5').innerHTML = blogJSON.blog_details.blogs[4].describe;
document.getElementById('sub_describe5').innerHTML = blogJSON.blog_details.blogs[4].sub_describe;
document.getElementById('author5').innerHTML = blogJSON.blog_details.blogs[4].author;